import { ExampleCodes } from '@/@types/components'

export const multiStepCodes: ExampleCodes = {
  componentCopy: `import { AnimatePresence, motion } from 'framer-motion'
...
export const MultiStep = {
  ...
  `,
  componentView: `import { AnimatePresence, motion } from 'framer-motion'
import * as React from 'react'
...
export const MultiStep = {
  ...
  `,
  usage: `import { MultiStep } from '@/components/ui/multi-step'
...
export function MultiStepExample() {
  return (
    <MultiStep.Root defaultValue="1">
      ...
      <div className="rounded-xl border bg-background p-6 lg:min-w-[500px]">
